...
class UserAnswerAdmin(admin.ModelAdmin):
    ...
    def short_question(self, obj):
        return f"{obj.question.question_text[:50]}..." if len(obj.question.question_text) > 50 else obj.question.question_text
    short_question.short_description = "Question"
    
    def selected_option_text(self, obj):
        return obj.selected_option.option_text[:50] + "..." if obj.selected_option else "-"
